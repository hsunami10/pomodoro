...
const App = () => {
  ...
  // const NATIVE_WIDTH = window.innerWidth;
  // const NATIVE_HEIGHT = window.innerHeight;

  // The percentage of the browser window to be taken up by the canvas
  const WINDOW_PERCENTAGE = 1;
  ...
  useEffect(() => {
    const resizeObserver = new ResizeObserver((event) => {
      ...
      if (browserWindowRatio > nativeRatio) {
        ...
        newHeight = Math.floor(newHeight * WINDOW_PERCENTAGE);
        ...
        newWidth = Math.floor(newWidth * WINDOW_PERCENTAGE);
